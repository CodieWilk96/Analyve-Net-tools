# Analyve-Net-tools
 A terminal-based network toolkit that features it own custom interface, over 15 network analysis & security protocol CLI tools that integrate with several complex GUI tools to make tasks simpler, and easy access to run any  of the tools included in the toolkit.
...
### Images
![Main-menu](https://github.com/user-attachments/assets/0f12e83f-13ad-4356-9a78-ed0fe506e445)

![Terminal-tools](https://github.com/user-attachments/assets/f446e75a-2953-42ef-b990-7d3c2cbd0121)

![Wireless-tools-menu](https://github.com/user-attachments/assets/b59dee71-4da7-450e-a2d2-e3b386f7da44)

![GUI-tools-menu](https://github.com/user-attachments/assets/60003397-62c7-4595-a1d3-5128a09703e1)
